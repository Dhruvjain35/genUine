...
import { Plus_Jakarta_Sans, DM_Sans, Instrument_Serif, Outfit } from 'next/font/google';
import './globals.css';
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
 ...
 <html
 lang="en"
 className={`${jakarta.variable} ${dm.variable} ${serif.variable} ${enrique.variable}`}
 >
 <body>
